...
repo = pd.read_csv('coordenadas3.csv',sep=',',header=0)
...
#Centrado en 755.23 +- (1.23)
ax.set_xlim3d([754000000000, 756460000000])
ax.set_xlabel('X')

#+-(1.23)
ax.set_ylim3d([-1230000000, 1230000000])
ax.set_ylabel('Y')

#Para poder observar un movimiento vertical
